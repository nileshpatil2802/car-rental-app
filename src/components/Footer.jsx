        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-8 border-t border-gray-700">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">+91 9373064688</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">manojkumarpatil1137@gmail.com</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">Mahadeo Nagar, Near A. M. College, Hadapsar, Pune.</p>
            </div>
          </div>
        </div>
      </div>
